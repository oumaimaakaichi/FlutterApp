...
import 'package:healthhub/Screens/Login-Signup/forgotPassDoctor.dart';
  ...
  userLogin(String email, String password) async {
    try {
      ...
      if (userSnapshot.exists &&
          (userSnapshot.data() as Map<String, dynamic>)['role'] == 'Docteur') {
        // Si l'email, le mot de passe et le rôle sont corrects, affichez un message de succès
        ...
        // Afficher le toast pour un utilisateur non autorisé
      ...
      if (e.code == 'user-not-found') {
        // Afficher le toast pour un utilisateur non trouvé
        Fluttertoast.showToast(
        ...
        // Afficher le toast pour un mot de passe incorrect
        Fluttertoast.showToast(
          msg: "Wrong password",
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
