...
import 'package:healthhub/Screens/Login-Signup/choixUser.dart';
...
import 'package:healthhub/Screens/On_Board/on_board1.dart';
import 'package:healthhub/Screens/On_Board/on_board2.dart';
import 'package:healthhub/Screens/On_Board/on_board3.dart';
            ...
            children: [
              ...
              SmoothPageIndicator(
                ...
                effect: SlideEffect(
                    ...
                    dotHeight: 7.0,
                    strokeWidth: 1.5,
                    dotColor: Color.fromARGB(255, 116, 180, 234),
                    activeDotColor: const Color.fromARGB(255, 116, 180, 234)),
              ),
              onLastpage
                  ? GestureDetector(
                      onTap: () {
